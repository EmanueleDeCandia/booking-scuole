    ...
    <div className="mx-auto max-w-md px-4 py-12">
      <div className="card-sketch bg-white/95 p-8 shadow-sketch">
        <div className="mb-6 text-center">
          <span className="sketch-sm inline-grid h-12 w-12 place-items-center bg-crayon-green text-2xl text-white">
            ✍️
          </span>
          <h1 className="font-display mt-3 text-3xl text-ink">Crea il Tuo Profilo</h1>
